...
@section('page-header')
    Diagnosticos CIE <small>{{ trans('app.manage') }}</small>
@stop
	...
	<div class="row">
	  <div class="col-xs-12">
	    <div class="box" style="border:1px solid #d2d6de;" >
          ...
          <a class="btn btn-info" href="{{ route(ADMIN . '.hist_diagnosticos.create') }}"  title="Add Item">
	      ...
	      <div class="box-body table-responsive no-padding"  >
            ...
            <tbody>
                      ...
                      <td><a>{{ $item->iddiagnosticocie }}</a></td>
